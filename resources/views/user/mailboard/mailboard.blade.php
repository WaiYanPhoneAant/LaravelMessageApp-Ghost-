...
<body>
    ...
    <nav>
        ...
        <div class="list">
            <ul class="menu-list">
                <li class="menu-item inbox active"><span><i class="fa-solid fa-inbox me-2"></i>Inbox</span> <span class="badge-inbox unread">0</span></li>
                <li class="menu-item send"><span><i class="fa-solid fa-paper-plane me-2"></i>Send</span></li>
